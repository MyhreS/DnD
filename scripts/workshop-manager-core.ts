...
export function workshopChannelContext(requesterEmail: string | undefined): string {
  return [
    ...
    "Simon (simonmyhre1@gmail.com), Christoffer (myhrefjeld@gmail.com), and Thomas (thmyhre9@gmail.com) are equally authorized Workshop owners. An authenticated reply from any of these accounts in the same thread can answer or unblock a protected decision.",
