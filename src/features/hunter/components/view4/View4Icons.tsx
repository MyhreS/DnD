...
export type View4IconName = "abilities" | "features" | "inventory" | "combat" | "notes" | "profile" | "resources" | "armor";
...
export function View4Icon({ name, ...props }: { name: View4IconName } & SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
    ...
    {name === "combat" && <><path d="m5 4 14 14" /><path d="m19 4-6 6M11 12l-6 6" /><path d="m3 3 4 1-3 3-1-4ZM21 3l-1 4-3-3 4-1ZM3 21l1-4 3 3-4 1ZM21 21l-4-1 3-3 1 4Z" /></>}
