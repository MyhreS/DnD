...
export function InventoryAddPageMenu() {
  ...
  return <div className="appsheet-add-choices character-sheet-inventory-add-menu">
    <button type="button" aria-label="Add from game catalogue" onClick={() => navigation.pushPage({
      ...
      <b>Add from game catalogue</b><span>Choose an established weapon, tool, or piece of gear.</span>
    </button>
    <button type="button" aria-label="Record a unique item" onClick={() => navigation.pushPage({
      ...
      <b>Record a unique item</b><span>Add a weapon or gear item found outside the game catalogue.</span>
    </button>
  </div>;
}
