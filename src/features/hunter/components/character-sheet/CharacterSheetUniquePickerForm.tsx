...
export function CharacterSheetUniquePickerForm({ config, onDone }: { config: UniquePickerConfig; onDone: () => void }) {
  ...
  return <form className="character-sheet-slot-unique" onSubmit={submit}>
