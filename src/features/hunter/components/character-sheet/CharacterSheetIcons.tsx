...
export type CharacterSheetIconName = "abilities" | "skills" | "features" | "inventory" | "notes" | "profile" | "resources" | "armor";

export function CharacterSheetIcon({ name, ...props }: { name: CharacterSheetIconName } & SVGProps<SVGSVGElement>) {
