...
export const DEEPCALLER_RITES: readonly DeepcallerReference[] = [
  ...
  { id: "armor-of-agathys", name: "Armor of Agathys", level: 1, kind: "Rite", school: "Protection", performing: "Bonus Action", range: "Self", duration: "20 rounds", damage: "5 on melee hit", damageType: "Cold" },
  { id: "arms-of-hadar", name: "Arms of Hadar", level: 1, kind: "Rite", school: "Summoning", performing: "Action", range: "Self", duration: "Instantaneous", damage: "2d6", damageType: "Acid" },
