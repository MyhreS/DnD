...
// carry significance, total weight, and the established carry-condition rule.
...
/** EVERYTHING carried: inventory + worn armor (including studs)
...
/** Carry condition from Strength score + carried weight in the app model
