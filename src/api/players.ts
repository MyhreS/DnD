 ...
 * campaign's hunters (party gallery / play board) — a `where` query whose cost
 * scales with the campaign, not the whole app. Omit it for the global corpus
 * (the DM search board, the idle fighter shows). */
