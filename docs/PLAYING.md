...
- **Menu mode** ✅ — the "out of game" home: upcoming **Sessions** + countdown,
  the **Party**, the **Codex**, and full **character management**. You can
...
gear, consumables), grouped by the established app catalog's **carry significance**
