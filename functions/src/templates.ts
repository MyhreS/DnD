...
export function inviteEmail(to: string, appUrl: string, firstName?: string): Mail {
  ...
  return {
    ...
    text: `${greeting}.\n\nYou've been added to our Catacombs & Starspawns party. Open the app and sign in with this Google account to forge your hunter, see when we play, and read the Codex.\n\n${appUrl}\n\n${HOW_TO}\n\nSee you in the fog.`,
    html: renderHtml({
      heading: greeting,
      bodyHtml: `<p>You've been added to our <strong>Catacombs &amp; Starspawns</strong> party.</p>
        <p>Sign in with <em>this</em> Google account to forge your hunter, see when we next play, and read the Codex.</p>
